...
function signOut(){
    ...
    firebase.auth().onAuthStateChanged(function(user) {
      if (user) {
        ...
        document.getElementById(`suh`).innerHTML = `${firebase.auth().currentUser.displayName}'s cart`
...
fetch(`https://sellit-fe700-default-rtdb.firebaseio.com/favourites/${userId}.json`)
    .then(data => {
