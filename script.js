...
function adCard(data, key){
  ...
  if(firebase.auth().currentUser === null){
    ...
    <div class="cardstyling col-lg-4 col-sm-6 portfolio-item">
      ...
      <h5>$ ${data.price}</h5>
      <button type="button" class="btn btn-primary" onclick="signInFirst()">Favourites</button>
 ...
 return`
  <div class="cardstyling col-lg-4 col-sm-6 portfolio-item">
    <div class="card h-100">
      ...
      <p class="validate card-text">${data.description}</p>
      <h5>$ ${data.price}</h5>
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" onclick="adChat('${key}',this)">Favourites</button>
